...
** Documentation:
*** Added team members' images in AboutUs (Pull request https://github.com[#3])
*** Edited `Valid Inputs` section in the User Guide (Pull request https://github.com[#204])
*** Added section for group in the User Guide (Pull request https://github.com[#155])
*** Edited `User Stories` and `Use Cases` in Developer Guide
*** Added section for group in the Developer Guide (Pull request https://github.com[#68])
*** Updated diagrams and images to be in TutorHelper context (Pull request https://github.com[#227])
** Community:
*** Reviewed other PRs
