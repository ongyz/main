...
The sequence diagram below illustrates the payment edit feature
    ...
    1. Current implementation
        ...
        The edit Payment mechanism is facilitated by VersionedAddressBook and FilteredList<Person>. VersionedAddressBook extends from AddressBook and classes related to Payment calls methods from VersionedAddressBook to retrieve students' data, update the Payment entry and display accordingly.
        ...
        b. PayCommand:
            ...
            -Calls on methods in VersionedAddressBook to update edit on existing Payments made.
        d. Payment:
...
* `AddressBookParser` -- Creates a EditSyllCommandParser object and calls parse method in object to parse user's argument input.
