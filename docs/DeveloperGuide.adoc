...
Step 2. Assuming that the application isn't empty, the user executes `copysub 1 2 n/John Doe`.
...
Step 5. The system will locate student(s) under the search name of `John Doe`.

Step 6. For each student found in Step 5, the system will make a decision.

* Step 6a. If the same subject as _second_ subject in Step 4, system will append the content of subject of _second_ subject into the found student.
* Step 6b. If there is no subject same as _second_ subject in Step 4, System will add the _second_ subject as a new subject under the found student.
