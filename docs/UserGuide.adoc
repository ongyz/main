...
Duplicate a subject from chosen student and add it to other students. +
Format: `copysub STUDENT_INDEX SUBJECT_INDEX STUDENT_NAME [MORE STUDENT_NAME]`

****
* The student index refers to the index number shown in the displayed student list.
* The subject index refers to the index number shown in the student's subject list.
* The Student name will be used for search keyword to find the students for the subject to be added.
* The search is case insensitive. e.g `hans` will match `Hans`
* The order of the keywords does not matter. e.g. `Hans Bo` will match `Bo Hans`
* Only the name is searched.
* Only full words will be matched e.g. `Han` will not match `Hans`
