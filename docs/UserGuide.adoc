...
=== Add a syllabus topic to the student’s list of syllabus topics : `todo`

Add a new syllabus topic for a specified student and subject. +
Format: `todo STUDENT_INDEX SUBJECT_INDEX sy/SYLLABUS`
...
=== Remove a syllabus topic from the student’s list of syllabus topics : `rmtodo`
