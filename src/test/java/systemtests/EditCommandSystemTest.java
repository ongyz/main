...
public class EditCommandSystemTest extends TutorHelperSystemTest {
    ...
    public void edit() {
        ...
        Person editedPerson = new PersonBuilder(BOB).withTags(VALID_TAG_HUSBAND).withSubjects(VALID_SUBJECT_AMY)
        ...
        command = EditCommand.COMMAND_WORD + " " + index.getOneBased() + NAME_DESC_BOB + PHONE_DESC_AMY + EMAIL_DESC_AMY
                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND;
        editedPerson = new PersonBuilder(BOB).withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withTags(
        ...
        /* Case: filtered person list, edit index within bounds of TutorHelper and person list -> edited */
        ...
        /* Case: filtered person list, edit index within bounds of TutorHelper but out of bounds of person list
         * -> rejected
         */
        showPersonsWithName(KEYWORD_MATCHING_MEIER);
        ...
        assertTrue(getModel().getTutorHelper().getPersonList().contains(BOB));
        index = INDEX_FIRST_PERSON;
