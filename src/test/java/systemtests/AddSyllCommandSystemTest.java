...
public class AddSyllCommandSystemTest extends TutorHelperSystemTest {
    ...
    public void appendsyll() {
        ...
        Person newPerson = addSyllPerson(
                expectedModel, INDEX_FIRST_PERSON, INDEX_FIRST_SUBJECT, syllabusTest);
        String expectedResultMessage = String.format(MESSAGE_ADDSYLL_SUCCESS, newPerson);
        ...
        addSyllPerson(modelBeforeAppendLast, lastPersonIndex, INDEX_FIRST_SUBJECT, syllabusTest);
