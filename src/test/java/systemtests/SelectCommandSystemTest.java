...
public class SelectCommandSystemTest extends TutorHelperSystemTest {
    ...
    public void select() {
        ...
        /* Case: filtered person list, select index within bounds of TutorHelper but out of bounds of person list
         * -> rejected
         */
        ...
        /* Case: filtered person list, select index within bounds of TutorHelper and person list -> selected */
