...
import static tutorhelper.logic.commands.SelectCommand.MESSAGE_SELECT_STUDENT_SUCCESS;
...
public class SelectCommandSystemTest extends TutorHelperSystemTest {
    @Test
    public void select() {
        ...
        /* Case: filtered student list, select index within bounds of TutorHelper but out of bounds of student list
         * -> rejected
         */
        ...
        /* Case: filtered student list, select index within bounds of TutorHelper and student list -> selected */
        ...
        /* Case: select from empty TutorHelper -> rejected */
        deleteAllStudents();
