...
public class TestApp extends MainApp {
    ...
    protected Supplier<ReadOnlyTutorHelper> initialDataSupplier = () -> null;
    protected Path saveFileLocation = SAVE_LOCATION_FOR_TESTING;

    public TestApp() {
    }

    public TestApp(Supplier<ReadOnlyTutorHelper> initialDataSupplier, Path saveFileLocation) {
        super();
        ...
        if (initialDataSupplier.get() != null) {
            createDataFileWithData(new XmlSerializableTutorHelper(this.initialDataSupplier.get()),
    ...
    protected UserPrefs initPrefs(UserPrefsStorage storage) {
        ...
        userPrefs.setTutorHelperFilePath(saveFileLocation);
        return userPrefs;
    }

    /**
     * Returns a defensive copy of the TutorHelper data stored inside the storage file.
     */
    public TutorHelper readStorageTutorHelper() {
        try {
            return new TutorHelper(storage.readTutorHelper().get());
        } catch (DataConversionException dce) {
            throw new AssertionError("Data is not in the TutorHelper format.", dce);
    ...
    public Path getStorageSaveLocation() {
        return storage.getTutorHelperFilePath();
    }
    ...
    public Model getModel() {
        Model copy = new ModelManager((model.getTutorHelper()), new UserPrefs());
