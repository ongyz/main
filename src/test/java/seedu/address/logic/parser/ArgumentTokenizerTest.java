...
public class ArgumentTokenizerTest {
     ...
     * and only the last subjectName is returned upon calling {@code ArgumentMultimap#getValue(Prefix)}.
     */
    private void assertArgumentPresent(ArgumentMultimap argMultimap, Prefix prefix, String... expectedValues) {

        // Verify the last subjectName is returned
    ...
    public void tokenize_oneArgument() {
        // Preamble present
        String argsString = "  Some preamble string p/ Argument subjectName ";
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(argsString, pSlash);
        assertPreamblePresent(argMultimap, "Some preamble string");
        assertArgumentPresent(argMultimap, pSlash, "Argument subjectName");

        // No preamble
        argsString = " p/   Argument subjectName ";
    ...
    public void tokenize_multipleArguments() {
        ...
        String argsString = "SomePreambleString -t dashT-Value p/pSlash subjectName";
        ...
        argsString = "Different Preamble String ^Q111 -t dashT-Value p/pSlash subjectName";
        ...
        argsString = unknownPrefix + "some subjectName";
        argMultimap = ArgumentTokenizer.tokenize(argsString, pSlash, dashT, hatQ);
    ...
    public void tokenize_multipleArgumentsWithRepeats() {
        ...
        String argsString = "SomePreambleString -t dashT-Value ^Q ^Q -t another dashT subjectName p/ pSlash subjectName -t";
        ArgumentMultimap argMultimap = ArgumentTokenizer.tokenize(argsString, pSlash, dashT, hatQ);
        assertPreamblePresent(argMultimap, "SomePreambleString");
        assertArgumentPresent(argMultimap, pSlash, "pSlash subjectName");
