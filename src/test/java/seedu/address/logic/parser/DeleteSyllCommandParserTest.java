...
public class DeleteSyllCommandParserTest {
    ...
    public void parse_validArgs_returnsDeleteSyllCommand() {
        assertParseSuccess(parser, "1 1 2",
                new DeleteSyllCommand(INDEX_FIRST_PERSON, INDEX_FIRST_SUBJECT, INDEX_SECOND_SYLLABUS));
        assertParseSuccess(parser, "2 3 1",
                new DeleteSyllCommand(INDEX_SECOND_PERSON, INDEX_THIRD_SUBJECT, INDEX_FIRST_SYLLABUS));
        assertParseSuccess(parser, "1 2 3",
                new DeleteSyllCommand(INDEX_FIRST_PERSON, INDEX_SECOND_SUBJECT, INDEX_THIRD_SYLLABUS));
    }
