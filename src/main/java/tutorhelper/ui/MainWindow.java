...
public class MainWindow extends UiPart<Stage> {
     ...
     * @param keyCombination the KeyCombination subjectName of the accelerator
     */
    ...
    void fillInnerParts() {
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(prefs.getTutorHelperFilePath());
