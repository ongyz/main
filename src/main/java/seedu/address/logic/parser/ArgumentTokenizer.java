...
/**
 * Tokenizes arguments string of the form: {@code preamble <prefix>subjectName <prefix>subjectName ...}<br>
 *     e.g. {@code some preamble text t/ 11.00 t/12.00 k/ m/ July}  where prefixes are {@code t/ k/ m/}.<br>
 * 1. An argument's subjectName can be an empty string e.g. the subjectName of {@code k/} in the above example.<br>
 * 2. Leading and trailing whitespaces of an argument subjectName will be discarded.<br>
 * 3. An argument may be repeated and all its values will be accumulated e.g. the subjectName of {@code t/}
...
public class ArgumentTokenizer {
     ...
     *
     * @param argsString Arguments string of the form: {@code preamble <prefix>subjectName <prefix>subjectName ...}
